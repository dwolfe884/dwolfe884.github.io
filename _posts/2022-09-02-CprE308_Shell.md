...
## Resources Used
I used so many Stack Overflow posts and a lot of help from the TA. On top of informal help, I also spent a fair amount of time reading the standards for ["MIPS assembly language"](https://www.cs.csub.edu/~eddie/cmps2240/doc/britton-mips-text.pdf) to ensure that my instructions were being parsed correctly